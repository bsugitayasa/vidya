  ...
  if (!verificationToken) return <div className="mx-auto max-w-xl px-4 py-10">
    <div className="rounded-3xl border border-orange-100 bg-white p-6 shadow-xl shadow-orange-100/40 sm:p-9">
      ...
      <form onSubmit={verify} className="mt-6 space-y-4">
        <label className="block text-sm font-bold text-slate-700">Nomor Pendaftaran<input required value={identity.nomorPendaftaran} onChange={(e) => setIdentity({ ...identity, nomorPendaftaran: e.target.value })} className={`${inputClass} mt-2`} placeholder="Contoh: PDPN-2026-0001" /></label>
